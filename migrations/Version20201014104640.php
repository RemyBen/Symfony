 ...
 */
final class Version20201014104640 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe CHANGE lieu_id idLieu INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe CHANGE idlieu lieu_id INT NOT NULL');
